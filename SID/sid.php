...
function _init( )
{
    ...
    $database = ($_REQUEST['select_database']) ? $_REQUEST['select_database'] : '';
...
function set_vars( )
{
    ...
    if($_REQUEST['SQLfield']) $SID['SQLfield'] = htmlspecialchars(stripslashes($_REQUEST['SQLfield']));
}
